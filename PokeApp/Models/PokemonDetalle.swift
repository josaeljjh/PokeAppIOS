...
//
//   let pokemonDetalle = try? newJSONDecoder().decode(PokemonDetalle.self, from: jsonData)

import Foundation

// MARK: - PokemonDetalle
class PokemonDetalle: Codable {
    let id: Int
    let name: String
    let names: [Name]
    ...
    let genderRate: Int
    let genera: [Genus]
    let generation, growthRate: Color
  ...
  enum CodingKeys: String, CodingKey {
    ...
    init(id: Int, name: String, names: [Name], baseHappiness: Int, captureRate: Int, color: Color, eggGroups: [Color], evolutionChain: EvolutionChain, evolvesFromSpecies: JSONNull?, formDescriptions: [JSONAny], formsSwitchable: Bool, genderRate: Int, genera: [Genus], generation: Color, growthRate: Color, hasGenderDifferences: Bool, hatchCounter: Int, isBaby: Bool, order: Int, shape: Color) {
        self.id = id
        self.name = name
        self.names = names
...
class Genus: Codable {
    ...
    init(genus: String, language: Color) {
        self.genus = genus
